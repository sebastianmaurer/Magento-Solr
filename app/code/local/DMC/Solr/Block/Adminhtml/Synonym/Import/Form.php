...
class DMC_Solr_Block_Adminhtml_Synonym_Import_Form extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    {
        $values = array();
        $path   = Mage::getBaseDir('media').DS.'solr'.DS.'synonyms'.DS.'default'.DS;
        if (file_exists($path)) {
