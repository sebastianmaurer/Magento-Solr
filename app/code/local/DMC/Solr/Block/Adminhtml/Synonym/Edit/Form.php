...
class DMC_Solr_Block_Adminhtml_Synonym_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $general->addField('query', 'text', array(
            'name'     => 'word',
        ...
        $general->addField('word', 'text', array(
                'name'     => 'synonyms',
                'label'    => Mage::helper('solr')->__('Synonyms'),
                'required' => true,
                'value'    => $model->getQueryText(),
                'note'     => 'synoym1, synonym2, synonym3,...'
        ));
