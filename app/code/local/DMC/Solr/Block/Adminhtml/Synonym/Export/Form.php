...
class DMC_Solr_Block_Adminhtml_Synonym_Export_Form extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $general->addField('exportMGSynonyms', 'checkbox', array(
                'name'     => 'exportMGSynonyms',
                'label'    => Mage::helper('solr')->__('Mage Synonyms Export'),
                'required' => false
        ));
