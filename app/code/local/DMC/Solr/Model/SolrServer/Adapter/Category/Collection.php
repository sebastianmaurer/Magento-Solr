...
class DMC_Solr_Model_SolrServer_Adapter_Category_Collection extends DMC_Solr_Model_SolrServer_Adapter_AbstractCollection
{
    ...
    {
        $product = Mage::getModel('catalog/catalog');
        $select->where('row_type:category');
